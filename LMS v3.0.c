...
void main_menu(){
    ...
    do{
        ...
        printf("\n     4.Display Current Student Details ");
        printf("\n     5.Add New Book ");
        printf("\n     6.Exit\n ");
        printf("\n____________________________________\n");
        printf("\nEnter your choice: ");
        ...
        switch(choice){
            ...
            case 3:{
                start_lib=display_lib(start_lib);
                break;
            }
            case 4:{
                display(start);
            ...
            case 5:{
                start_lib=add_new_book(start_lib);
                break;
            }
            case 6:{
                exit(1);
...
struct book *display_lib(struct book *start_lib){
    struct book *ptr;
    int i=1;
    if(start_lib==NULL){
...
struct book *add_new_book(struct book *start_lib){
    char bookname[30],authorname[30];
    int id;
